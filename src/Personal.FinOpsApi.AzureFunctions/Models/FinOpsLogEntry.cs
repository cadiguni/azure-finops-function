...
public class FinOpsLogEntry
{
    ...
    /// <summary>
    /// 🏷️ Nome do recurso (extraído do resourceId)
    /// </summary>
    [JsonPropertyName("resourceName")]
    public string ResourceName { get; set; } = string.Empty;

    /// <summary>
    /// ⚙️ Tipo do recurso (Microsoft.Compute/disks, Microsoft.Network/publicIPAddresses, etc.)
    /// </summary>
    ...
    /// <summary>
    /// 🏷️ Tags do recurso (formato JSON string para facilitar KQL)
